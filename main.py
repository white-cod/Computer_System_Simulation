...
def main():
    ...
    os = OperatingSystem(name="SimOS 1.0", required_ram_gb=4, required_storage_gb=20)
    ...
    print("\n[Rendering Video]")
    my_computer.process_user_task("Render video 'Project.mp4'", required_cores=12, required_iface="Ethernet")
    
    print("\n[Typing in Ukrainian]")
    my_computer.process_user_task("Type using ukr layout", required_cores=1)

    print("\n[Saving Work]")
    my_computer.save_work("Media1", data_size_gb=1000)
    print("\n[Saving Work]")
    my_computer.save_work("Media1", data_size_gb=1000)
